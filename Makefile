...
LIBS=-lpthread -lm -lrtlsdr -lusb-1.0
...
dump1090: dump1090.o anet.o crc.o mode_s.o net_io.o demod_2400.o icao_filter.o util.o convert.o $(COMPAT)
	$(CC) -g -o $@ $^ $(LIBS) $(LIBS_RTL) $(LDFLAGS)

clean:
	rm -f *.o compat/clock_gettime/*.o compat/clock_nanosleep/*.o dump1090
